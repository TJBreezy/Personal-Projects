function [time,quake_data,X] = quake_SAC2d_nofig ( quake_set, delta_t, f_lo,f_hi,seed)
...
%  fprintf('\n');
 ...
 P  = max(P0+P1+P2+4*P3,30/delta_t); % total number of points in earthquake record
